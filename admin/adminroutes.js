...
const { getAllDoctors, getAllPatients, adminlogin, registeradmin , verified, deleteUser, getdetails, updateDoctor, updatePatient, activation} = require('./Controller/admincontroller')
